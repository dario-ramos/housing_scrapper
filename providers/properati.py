...
class Properati(BaseProvider):
    def props_in_source(self, source):
        ...
        while True:
            ...
            if page == 1:
                nav_list = page_content.select(
                    '#page-wrapper > div.results-content > div.container.wide-listing > div.content > div.row.items-container > div.item-list.span6 > div > div.pagination.pagination-centered > ul > li')
            ...
            for prop in properties:
                ...
                internal_id = prop.find(
                    'a', class_='icon-fav')['data-property_id']
